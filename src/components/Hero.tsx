...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center justify-center pt-20 pb-32 overflow-hidden">
      ...
      <div 
        className="absolute inset-0 z-0 opacity-[0.5] dark:opacity-[0.5] mix-blend-multiply dark:mix-blend-screen transition-opacity duration-500 pointer-events-none"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-card text-gold-dark text-sm font-medium mb-4">
            ...
            <span>Best Astrologer in Bhilwara</span>
          </div>
          ...
          <h2 className="max-w-2xl mx-auto text-lg md:text-xl text-dark/70 font-light mb-10">
            Discover life paths and possibilities through premium astrological guidance by Pranjal Pandey, the top astrologer in Bhilwara.
          </h2>
